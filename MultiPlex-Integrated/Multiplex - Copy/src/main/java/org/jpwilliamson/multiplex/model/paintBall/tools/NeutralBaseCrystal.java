package org.jpwilliamson.multiplex.model.paintBall.tools;
...
import org.jpwilliamson.multiplex.model.paintBall.PaintBallSettings;
...
public class NeutralBaseCrystal extends VisualTool<PaintBallArena> {

	@Getter
	private static final Tool instance = new NeutralBaseCrystal();

	/**
	 * Create new tool for the arena type
	 */
	private NeutralBaseCrystal() {
		super(PaintBallArena.class);
	}
...
//	 */
	@Override
	protected String getBlockName(final Block block, final Player player, final PaintBallArena arena) {
...
//	 */
	@Override
	protected CompMaterial getBlockMask(final Block block, final Player player, final PaintBallArena arena) {
		final ArenaTeam team = findTeam(block.getLocation(), arena);
...
//	 */
	@Override
	protected void handleBlockClick(final Player player, final PaintBallArena arena, final ClickType click, final Block block) {
		...
		final PaintBallSettings settings = arena.getSettings();
...
//	 */
	@Override
	protected void handleAirClick(final Player player, final PaintBallArena arena, final ClickType click) {
	 ...
	 * @return
	 */
	private ArenaTeam findTeam(final Location location, final PaintBallArena arena) {
...
//	 */
	@Override
	protected List<Location> getVisualizedPoints(final PaintBallArena arena) {
