package org.jpwilliamson.multiplex.util;

import lombok.experimental.UtilityClass;
import org.jpwilliamson.multiplex.model.ArenaListener;
...
public class Constants {
	...
	public class Tag {
		...
		/**
		 * Players having this metadata tag may be teleported without restrictions set in {@link ArenaListener}
		 */
