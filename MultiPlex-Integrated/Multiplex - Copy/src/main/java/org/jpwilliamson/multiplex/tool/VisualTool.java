package org.jpwilliamson.multiplex.tool;
...
public abstract class VisualTool<T extends Arena> extends ArenaTool<T> {
	...
	/**
	 * @see ArenaTool#onAirClick(org.bukkit.entity.Player, Arena, org.bukkit.event.inventory.ClickType)
	 */
	@Override
	...
	/**
	 * @see ArenaTool#onEditStart(org.bukkit.entity.Player, Arena)
	 */
	@Override
	...
	/**
	 * @see ArenaTool#onHotbarFocused(org.bukkit.entity.Player, Arena)
	 */
	@Override
	...
	/**
	 * @see ArenaTool#onEditStop(org.bukkit.entity.Player, Arena)
	 */
	@Override
	...
	/**
	 * @see ArenaTool#onHotbarDefocused(org.bukkit.entity.Player, Arena)
	 */
	@Override
