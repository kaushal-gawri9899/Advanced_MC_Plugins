...
////import org.jpwilliamson.multiplex.model.eggwars.EggWarsArena;
////import org.jpwilliamson.multiplex.model.eggwars.EggWarsSettings;
...
//		final EggWarsSettings.ShopItem item = arena.getSettings().getItem(slot);
//
//		if (item == null)
//			return;
//
...
//		 * The item
//		 */
//		private final EggWarsSettings.ShopItem item;
//
//		/**
...
//			final EggWarsSettings.ItemCurrency currency = ReflectionUtil.lookupEnum(EggWarsSettings.ItemCurrency.class, split[1]);
//
