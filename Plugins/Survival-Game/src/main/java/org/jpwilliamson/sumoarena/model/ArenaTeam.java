...
public final class ArenaTeam extends YamlConfig {
	...
	public void assignTo(final Player player) {
		...
		Valid.checkBoolean(canAssign(player, arena), "Player " + player.getName() + " may not be assigned team " + name);
	...
	public boolean equals(final Object object) {
		return object instanceof ArenaTeam && ((ArenaTeam) object).getName().equals(this.name);
	}

	@Override
	public String toString() {
		return "ArenaTeam{" + name + "}";
	}
