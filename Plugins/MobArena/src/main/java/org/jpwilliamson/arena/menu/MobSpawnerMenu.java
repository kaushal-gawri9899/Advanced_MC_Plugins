...
import org.jpwilliamson.arena.model.monster.MobArenaSettings;
...
public class MobSpawnerMenu extends Menu {
	...
	public MobSpawnerMenu(final MobArenaSettings.MobSpawnpoint point) {
		setSize(9 * 3);
	...
	private final static class MonsterSelectMenu extends MenuPagged<EntityType> {
		 ...
		 */
		private final MobArenaSettings.MobSpawnpoint point;

		private MonsterSelectMenu(final Menu parent, final MobArenaSettings.MobSpawnpoint point) {
	...
	private final class MultiplierPrompt extends SimplePrompt {
		...
		private MultiplierPrompt(final MobArenaSettings.MobSpawnpoint point) {
			super(false);
