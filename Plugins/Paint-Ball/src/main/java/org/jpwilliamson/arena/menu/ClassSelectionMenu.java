...
import org.jpwilliamson.arena.model.ArenaClass.ArenaClassTier;
...
public class ClassSelectionMenu extends MenuPagged<ArenaClass> {
	...
	private ClassSelectionMenu(final Menu parent, final Player player, final Arena arena, final ViewMode viewMode) {
		...
		//FontImageWrapper w = new FontImageWrapper("mcguis:blank_menu");
	//	voteMenu = new VoteMenu((BuildBattleArena) arena, null, player);
