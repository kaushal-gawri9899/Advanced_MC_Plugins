...
public class MobSpawnerMenu extends Menu {
	...
	public MobSpawnerMenu(final SurvivalArenaSettings.MobSpawnpoint point) {
		setSize(9 * 3);
	...
	private final static class MonsterSelectMenu extends MenuPagged<EntityType> {
		 ...
		 */
		private final SurvivalArenaSettings.MobSpawnpoint point;

		private MonsterSelectMenu(final Menu parent, final SurvivalArenaSettings.MobSpawnpoint point) {
	...
	private final class MultiplierPrompt extends SimplePrompt {
		...
		private MultiplierPrompt(final SurvivalArenaSettings.MobSpawnpoint point) {
			super(false);
