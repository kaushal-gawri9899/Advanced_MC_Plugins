package org.jpwilliamson.sumoarena.tool.test;
...
import org.jpwilliamson.sumoarena.model.TestArena.TestArenaSettings;
 ...
 */
public class TestTool extends VisualTool<TestArena> {

	@Getter
	private static final Tool instance = new TestTool();

	/**
	 * Create new tool for the arena type
	 */
	private  TestTool() {
		super(TestArena.class);
	}
	 ...
	 */
	@Override
	protected String getBlockName(final Block block, final Player player, final TestArena arena) {
	 ...
	 */
	@Override
	protected CompMaterial getBlockMask(final Block block, final Player player, final TestArena arena) {
	 ...
	 */
	@Override
	protected void handleBlockClick(final Player player, final TestArena arena, final ClickType click, final Block block) {

		final TestArenaSettings settings = arena.getSettings();
	 ...
	 */
	@Override
	protected List<Location> getVisualizedPoints(final TestArena arena) {
